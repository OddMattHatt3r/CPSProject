...
import { name, socialProfiles } from '../../../my_info';
import Navbar from '../Navbar/Navbar';
import Typewriter from '../Typewriter/Typewriter';
import './Hero.css';
import { backgroundImageUrl } from '../../../my_info';
...
const Hero = () => {
  ...
  const heroStyle = {
    backgroundImage: `url(https://st3.depositphotos.com/1502607/18413/i/450/depositphotos_184131062-stock-photo-abstract-dots-wave-space-background.jpg)`,
  };
          ...
          <div className='hero-content'>
            <div className='name-container wow fadeInLeft' data-wow-delay='.4s'>
              <name>
                ...
                <h1 className='last-name'>Hagg</h1>
              </name>
            </div>
